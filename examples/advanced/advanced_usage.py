...
def demonstrate_split_vs_flat():
    ...
    print("   ./example_cache_split/functions/[module]/split_example/arg0=42/result.parquet")
    print("✅ Flat structure created at:")
    print("   ./example_cache_flat/functions/[module.flat_example]/arg0=42/result.parquet")
...
def demonstrate_custom_configurations():
    ...
    def run_simulation(
        ...
        print(f"🧪 Running {simulation_type} with {particles} particles at {temperature}K")
...
def demonstrate_argument_handling():
    ...
    @cache(
        cache_dir="./args_demo",
        max_arg_length=25,
        symlink_name="args_result.parquet"
    )
    def complex_function(
        ...
        print(f"🔧 Processing with numbers={numbers}, config={config}, flag={flag}, mode={mode}")
